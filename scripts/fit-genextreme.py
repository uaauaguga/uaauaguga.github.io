...
def load_records(path,data_type ="sequence,structure,annotation"):
...
def prepare_dataset(records):
    ...
    for seq_id in records.keys():
        ...
        dataset[seq_id] = get_kmer(X,y,flankingL = 2)
    return dataset
...
def main():
    ...
    records = load_records(args.input,data_type ="sequence,structure,reactivity")
    print("Done .")
